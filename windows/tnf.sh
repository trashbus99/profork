...
URL="https://github.com/trashbus99/profork/releases/download/r1/TeatherNFeather.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
DEST_DIR="/userdata/roms/windows"
MESSAGE="TeatherNFeather - Needs Enable DXVK in adv. settings before running"  # Leave empty if no message is needed
