...
apps=(
    ...
    ["LINUX-VMS-QEMU/DOCKER"]="curl -Ls https://github.com/trashbus99/profork/raw/master/docker/qemu.sh | bash"
    ["LINUX-VMS-QEMU-ARM64/DOCKER"]="curl -Ls https://github.com/trashbus99/profork/raw/master/docker/qemu-arm.sh | bash"
    # Add other apps here
)
