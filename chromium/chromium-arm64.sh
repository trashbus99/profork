...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/chromium/extra/icon.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
wget -q -O "/userdata/roms/ports/Chromium.sh.keys" "https://github.com/trashbus99/profork/raw/master/xcloud/extra/xcloud.sh.keys"
# --------------------------------------------------------------------
