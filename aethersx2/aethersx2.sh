...
######################################################################
dialog --title "Aethesx2 Notice" --yesno "Aethesx2 is experimental and was tested on a v42dev build for the Odin 2. Some device gpu drivers are incompatible (e.g. orange pi 5 panfrost drivers) Compatibility may vary. Continue Installing?" 12 50
...
# --------------------------------------------------------------------
# --------------------------------------------------------------------
APPNAME=AETHERSX2 # for installer info
appname=aethersx2 # directory name in /userdata/system/pro/...
AppName=$appname # App.AppImage name
APPPATH=/userdata/system/pro/$appname/$appname.AppImage
#APPLINK=http://PROFORK/app/$appname.AppImage
APPLINK=https://github.com/trashbus99/profork/releases/download/r1/AetherSX2.AppImage
...
wget --tries=10 --no-check-certificate --no-cache --no-cookies -q -O $pro/$appname/extra/icon.png https://github.com/trashbus99/profork/raw/master/aethersx2/extra/aethersx2.png; chmod a+x $dep/* 2>/dev/null; cd ~/
...
# Download PS2 Parser
wget -q --tries=50 --no-check-certificate --no-cache --no-cookies -O /userdata/roms/ps2/+UPDATE-PS2-SHORTCUTS.sh https://github.com/trashbus99/profork/raw/master/aethersx2/%2BUPDATE-PS2-SHORTCUTS.sh
